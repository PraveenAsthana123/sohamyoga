  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
        ...
        App IDs are safe identifiers — not secret. App Secrets are sent via HTTPS to <code>/api/social/setup</code> which writes them to OpenBao at <code>slp-portal/&lt;platform&gt;</code>. They are never stored in the browser, git, or logs.
      </div>
    </div>
  );
}
