    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-6 flex gap-3 text-sm">
        ...
        <div className="text-amber-800">
          ...
          Credentials submitted here travel over HTTPS to <code className="bg-amber-100 px-1 rounded">/api/config/credentials</code>, which writes them to OpenBao at <code className="bg-amber-100 px-1 rounded">slp-portal/portals/&lt;name&gt;</code>. They are immediately cleared from the browser after save. Only your OpenBao instance can decrypt them.
        </div>
      </div>
