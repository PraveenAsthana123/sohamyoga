        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradientFrom = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    GradientTo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceInterest = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustrySolutions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmtpPassword = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    NewsletterEnabled = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorTitle = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoDemos", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndustrySolutions_Slug",
                table: "IndustrySolutions",
                column: "Slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterSubscribers_Token",
                table: "NewsletterSubscribers",
                column: "Token",
                unique: true);
