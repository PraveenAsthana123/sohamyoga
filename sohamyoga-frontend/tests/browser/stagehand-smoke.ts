...
const baseURL=process.env.SOHAM_BASE_URL||'http://127.0.0.1:8095';const gateway=process.env.SOHAM_OLLAMA_GATEWAY_URL||'http://127.0.0.1:8091/v1';const model=process.env.STAGEHAND_MODEL||'qwen2.5:latest';
async function main(){
