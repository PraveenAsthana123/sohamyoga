...
- Name: unified-quality.spec.ts >> PUBLIC-CATALOG-001 | visitor | positive route and UI contract
- Location: tests/e2e/unified-quality.spec.ts:7:6
...
Call log:
  - navigating to "http://127.0.0.1:8085/catalog", waiting until "networkidle"
