...
interface Appointment { id: number; patient_id: number; first_name: string; last_name: string; physio: string; appointment_date: string; start_time: string; end_time: string; treatment_type: string; status: string; primary_diagnosis: string; wca_claim_number: string; fee: number; subjective: string; objective: string; assessment: string; plan: string; }
