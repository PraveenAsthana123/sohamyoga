    ...
    <div className="rounded-lg border p-3 bg-gray-50">
      ...
      {asset.status === 'review_required' && (
        <div className="mt-2 flex gap-2">
          <button onClick={() => onDecide(asset.id, 'approve')} className="rounded bg-green-700 px-3 py-1 text-xs font-medium text-white hover:bg-green-800">Approve</button>
