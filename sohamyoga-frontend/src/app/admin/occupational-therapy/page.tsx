...
interface OTSession { id:number; client_id:number; first_name:string; last_name:string; ot:string; session_date:string; start_time:string; end_time:string; session_setting:string; session_type:string; status:string; funding_source:string; wca_claim:string; diagnosis:string[]; fee:number; client_participation:string; home_assessment_required?:boolean; }
