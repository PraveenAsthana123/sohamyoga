  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-white/60 mt-1 text-sm">Here&apos;s an overview of your activity.</p>
      </div>
      ...
      {chatSessions.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold text-white mb-3">Recent Chat Sessions</h2>
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-xs text-white/40 mt-0.5">{s.messageCount} messages</p>
                  </div>
