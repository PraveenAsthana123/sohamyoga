        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20  rounded-xl px-4 py-3 text-white text-sm font-semibold transition-all"
            >
