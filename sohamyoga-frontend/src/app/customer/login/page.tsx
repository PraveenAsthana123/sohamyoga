      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mt-6 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/35 text-xs tracking-wide">or sign in with</span>
            <div className="flex-1 h-px bg-white/15" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <a
              href="/api/auth/google"
              className="flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-sm rounded-xl px-4 py-3 text-white text-sm font-semibold transition-all"
            >
