  ...
  return (
    <article className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-shadow">
      ...
      <div className="relative aspect-video bg-gray-900">
        ...
        {/* Muted badge */}
        <div className="absolute top-3 right-3 bg-black/60 text-white/80 text-xs px-2 py-0.5 rounded-full  flex items-center gap-1">
        ...
        {/* Duration */}
        {video.duration && (
          <div className="absolute bottom-10 right-3 bg-black/60 text-white text-xs px-2 py-0.5 rounded-full ">
            {video.duration}
          </div>
        )}
