# Anthropic Superpowers · Deep Dive

> Claude Code skill framework · brainstorming · TDD · debugging · planning skills · also a plugin marketplace
> Category: Agentic Methodology · License: MIT (Anthropic) · Port: none

## 1. Overview + when-to-use

Claude Code skill framework · brainstorming · TDD · debugging · planning skills · also a plugin marketplace

### When to use Anthropic Superpowers

| Use Anthropic Superpowers when... | Use alternative when... |
|---|---|
...
| §91 layer | Default | With Anthropic Superpowers |
|---|---|---|
...
| Methodology | (manual) | **Anthropic Superpowers** drives the dev loop |
...
- Tool homepage: search "Anthropic Superpowers"
