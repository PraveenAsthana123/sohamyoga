# BMAD (Build-Measure-Analyze-Deploy) · Deep Dive

> Iterative agentic dev cycle · already present in repo at _bmad/ · operator-tailored agent council pattern
> Category: Agentic Methodology · License: — · Port: none

## 1. Overview + when-to-use

Iterative agentic dev cycle · already present in repo at _bmad/ · operator-tailored agent council pattern

### When to use BMAD (Build-Measure-Analyze-Deploy)

| Use BMAD (Build-Measure-Analyze-Deploy) when... | Use alternative when... |
|---|---|
...
| §91 layer | Default | With BMAD (Build-Measure-Analyze-Deploy) |
|---|---|---|
...
| Methodology | (manual) | **BMAD (Build-Measure-Analyze-Deploy)** drives the dev loop |
...
- Tool homepage: search "BMAD (Build-Measure-Analyze-Deploy)"
