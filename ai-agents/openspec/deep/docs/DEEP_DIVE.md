...
> Open specification tooling for AI agent contracts · YAML/JSON schemas for agent behaviors · OSS
> Category: Spec-Driven Methodology · License: Apache-2.0 · Port: none
...
| Use OpenSpec when... | Use alternative when... |
|---|---|
...
```bash
./scripts/setup_ai_agent_stack.sh --tool openspec
```
...
| §91 layer | Default | With OpenSpec |
|---|---|---|
...
| Methodology | (manual) | **OpenSpec** drives the dev loop |
