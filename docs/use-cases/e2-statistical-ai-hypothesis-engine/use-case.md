# Use Case · Statistical Ai Hypothesis Engine

> **Block** · E2 · **Dept** · 10 · **Status** · stub (operator fills sections)
> Generated from §90 catalog. Edit this file in-place.

## 1. Use case

Dept 10 Actuarial · t-test/KS/Anderson
...
|---|---|---|---|
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-INFERENCE` | per request OR `*/5 * * * *` | run model | predictions table |
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-DRIFT-CHECK` | hourly | PSI / KS drift | drift_metrics |
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-RETRAIN` | `0 3 * * 1` | weekly retrain | MLflow run |
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-VECTOR-INGEST` | `*/15 * * * *` | embed → vector DB (per §87.4 + §90.5) | vector_db |
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-HITL-AUDIT` | `0 9 * * *` | sample overrides for retrain | hitl_audit |
| `INSUR-STATISTICAL_AI_HYPOTHESIS_ENGINE-FAIRNESS-AUDIT` | `0 9 * * 1` | per-cohort metric audit | fairness_audit |
